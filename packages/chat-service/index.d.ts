...
export declare class ChatProviderUtils {
   ...
   */
  static handleToolLoop<TResponse>(
    handler: ProviderToolHandler<TResponse>,
    model: string,
...
export declare interface IChatProvider {
  ...
  setTools(
    tools: ToolDefinition[],
    onToolExecute: (toolUse: ToolUse) => Promise<ToolResult>,
    onFileReceived?: (
      threadId: string,
      fileId: string,
      mimeType: string,
...
export declare class TokenAccumulator {
  ...
  constructor(
    ...
    model: string,
    prompt: any[],
    onComplete: (auditData: ChatAuditData) => void,
    onTokenReceived?: (token: string) => void,
  );
  /**
