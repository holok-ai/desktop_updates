...
/**
 * electron-log/renderer is automatically initialized and ready to use
 * No initialization needed in renderer/preload processes
 */
 ...
 * In your Angular code, you'll be able to access window.electronAPI with full type safety.
 */
declare global {
  interface Window {
